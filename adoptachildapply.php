...
<table class="table table-striped table-bordered" style="width: 100%;">
	<thead>
		...
		<tr>
			<th style="width: 250px;">Child's Name after adaption</th>
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="form-group">
				...
				<input type="text" class="input" placeholder="Optional" name="workingfor" id="workingfor">
		...
		<div class="col-md-6">
			<div class="form-group">
				<b>Child's Name after adaption</b>
